<?php
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,jpeg,png,bmp,pdf,doc,docx,xls,xlsx";//,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,wmv,mp4
	...
	$mcImageManagerConfig['thumbnail.width'] = "200"; // px
	$mcImageManagerConfig['thumbnail.height'] = "200"; // px
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,wmv,pdf,mp4,doc,docx,xls,xlsx";
	...
	$mcImageManagerConfig['upload.max_width'] = "1366"; // Only if force_width_height is true
	$mcImageManagerConfig['upload.max_height'] = "768"; // Only if force_width_height is true
...
//	$mcImageManagerConfig['authenticator.allow_override'] = "*";
	...
	$mcImageManagerConfig['log.max_size'] = "2000k";
