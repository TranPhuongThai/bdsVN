...
$route['tim-nha-dat-binh-duong/(:any)/(:num)/(:num)/(:num)/(:num)/(:num)/(:num)/(:num)/(:num)']      = "pagereal/search/$1/$2/$3/$4/$5/$6/$7/$8";
$route['tim-nha-dat-binh-duong/(:any)/(:num)/(:num)/(:num)/(:num)/(:num)/(:num)/(:num)']      = "pagereal/search/$1/$2/$3/$4/$5/$6/$7/$8";
