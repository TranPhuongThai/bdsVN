...
class Zone extends MX_Controller{
    ...
    public function right4(){
        ...
        $this->load->view("zone/zone-right4",$data);

    }


    public function right5($realCheck, $comments){
    ...
    public function leftUser($mod = 'real'){
        ...
        $this->load->view("zone/zone-leftUser",$data);
