...
<ul class="news-list-3 new-list-3-addition">
<?php foreach($real_list as $row){ ?>
    <li>

    <div class="row">
        <div class="col-sm-8">
            <b><a class="tit tit2" href="<?php echo base_url()._setURL($row['Name'])."-real-".$row['ID'].".html";?>" title="<?php echo $row['Name'];?>"><?php echo $row['Name'];?></a></b>
        </div>
    ...
    <div class="col-sm-8 sale-news-list-detail">
        ...
        <div class="row">
            ...
            <label><span class="glyphicon glyphicon-map-marker"></span>&nbsp;&nbsp;</label> <?php echo $row['DName'];?>
        </div>
        <div class="row value">
