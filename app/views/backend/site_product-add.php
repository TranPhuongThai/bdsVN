...
$mtit = array(
    "name"      => "mtit",
    "value"     => set_value("mtit"),
    "class"     => "text width-400 height-32 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$mkey = array(
    "name"      => "mkey",
    "value"     => set_value("mkey"),
    "class"     => "text width-400 height-32 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$mdes = array(
    "name"      => "mdes",
    "value"     => set_value("mdes"),
    "class"     => "text width-400 height-32 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$submit = array(
    'name'      => 'bntOk',
...
<div class="content content-product padding-10 margin-10 background-color-f4f4f4 border-1 border-radius-8 border-color-ccc border-style-solid">
    <div class="section-left float-left">
        ...
        <?php 
            ...
            echo "<div class=\"item item-text\">".form_label(lang('backend.maker')." <span class=\"color-red\">*</span>")."<select name = 'maker'>".$maker_list."</select>"."<div class=\"clear-both\"></div></div>";
