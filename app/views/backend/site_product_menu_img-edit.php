    ...
    <div class="section-right float-right">
        <table border="0" cellpadding="0" cellspacing="0" class="table-list-item">
            ...
            <tr class="row">
                ...
                <td class="row-3"><a href="<?php echo base_url()."admin/site_product_menu_img/edit/".$row['ID'];?>" title="<?php echo lang('backend.edit');?>" class="color-blue hover-underline"><?php echo $row['Name'];?></a><br /></td>
                <td class="row-4 text-align-center"><?php echo $row['Level'];?></td>
