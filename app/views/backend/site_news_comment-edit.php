...
$name = array(
    "name"      => "name",
    "value"     => $comment_check['Name'],
    "class"     => "required focus text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$email = array(
    "name"      => "email",
    "value"     => $comment_check['Email'],
    "class"     => "focus text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$content = array(
    "name"      => "content",
    "value"     => $comment_check['Content'],
    "id"        => "CONTENT",
...
<div class="content content-news padding-10 margin-10 background-color-f4f4f4 border-1 border-radius-8 border-color-ccc border-style-solid">
    <div class="section-left float-left">
        ...
        <?php 
            ...
            echo "<div class=\"item item-text\">".form_label("Trả lời <span class=\"color-red\">*</span>").form_textarea($reply)."<div class=\"clear-both\"></div></div>";
            echo "<div class=\"item item-text\">".form_label("Hiển thị").form_checkbox($status)."<div class=\"clear-both\"></div></div>";
