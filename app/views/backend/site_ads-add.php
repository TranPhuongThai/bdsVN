...
$dateset = array(
    "name"      => "dateset",
    "value"     => set_value("dateset"),
    "class"     => "datepicker-2 required text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$expired = array(
    "name"      => "expired",
    "value"     => set_value("expired"),
    "class"     => "datepicker-2 required text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$status = array(
    "name"      => "status",
...
<div class="content content-ads padding-10 margin-10 background-color-f4f4f4 border-1 border-radius-8 border-color-ccc border-style-solid">
    <div class="section-left float-left">
        ...
        <?php 
            ...
            echo "<div class=\"item item-text\">".form_label(lang('backend.position')." ").form_dropdown('local',$localList,set_value("local"))."<div class=\"clear-both\"></div></div>";
