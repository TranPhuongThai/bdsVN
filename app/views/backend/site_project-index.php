...
<div class="content content-project padding-10 margin-10 background-color-f4f4f4 border-1 border-radius-8 border-color-ccc border-style-solid">
    ...
    <div class="search">
        <?php
            echo form_open(base_url()."admin/site_project/search",$form);
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table-list-item">
        <tr class="head">
            ...
            <td class="row-9">
                <a href="<?php echo base_url()."admin/site_project/add";?>" class="bntAddBig  padding-0 margin-0 text-align-left font-weight-bold border-0 cursor-pointer hover-blue no-underline border-radius-5 hover-border-shadow"><?php echo lang('backend.add');?></a>
            </td>
        </tr>
        <?php $stt = 1; foreach($project_list as $row){ ?>
        <tr class="row">
            <td class="row-1 text-align-center"><?php echo $stt;?></td>
            <td class="row-2 text-align-center"><?php echo $row['ID'];?></td>
            <td class="row-3"><a href="<?php echo base_url()."admin/site_project/edit/".$row['ID'];?>" title="<?php echo lang('backend.edit');?>" class="color-blue hover-underline"><?php echo $row['Name'];?></a></td>
            <td class="row-3"><a href="<?php echo base_url()."admin/site_project/edit/".$row['ID'];?>" title="<?php echo lang('backend.edit');?>" class="color-blue hover-underline"><img src="<?php echo $row['Thumb1'];?>"/></a></td>
