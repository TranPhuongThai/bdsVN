...
$address = array(
    "name"      => "address",
    "value"     => $email_check['Address'],
    "class"     => "text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);

$content = array(
    "name"      => "content",
    "value"     => $email_check['Content'],
    "id"        => "CONTENT",
...
<div class="content content-email padding-10 margin-10 background-color-f4f4f4 border-1 border-radius-8 border-color-ccc border-style-solid">
    <div class="section-left float-left">
        ...
        <?php 
            ...
            echo "<div class=\"item item-text\">".form_label(lang('backend.email')." <span class=\"color-red\">*</span>").form_input($email)."<div class=\"clear-both\"></div></div>";
            echo "<div class=\"item item-text\">".form_label(lang('backend.phone')." ").form_input($phone)."<div class=\"clear-both\"></div></div>";
            echo "<div class=\"item item-text\">".form_label(lang('backend.province')." ").form_dropdown("province",$province_list,set_value("province"),$province_attr)."<div class=\"clear-both\"></div></div>";
            ...
            echo "<div class=\"item item-text\">".lang('backend.content')." <span class=\"color-red\">*</span><br/>( {contact_name},{contact_email},{contact_phone},{contact_address},{contact_content} )<br/><br/>".form_textarea($content)."<script type=\"text/javascript\">var fullVi = new InnovaEditor(\"fullVi\");FullEditor(fullVi, \"CONTENT\", 400);</script><div class=\"clear-both\"></div></div>";
    ...
    <div class="section-right float-right">
        <table border="0" cellpadding="0" cellspacing="0" class="table-list-item">
            ...
            <tr class="row">
                ...
                <td class="row-3"><a href="<?php echo base_url()."admin/site_contact_email/edit/".$row['ID'];?>" title="<?php echo lang('backend.edit');?>" class="color-blue hover-underline"><?php echo $row['Name'];?></a><br /></td>
