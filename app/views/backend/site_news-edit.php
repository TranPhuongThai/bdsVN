...
if($news_check['Status'] == 1){
    $status["checked"] = "checked";
}
$editor = array(
    "name"      => "editor",
    "value"     => $news_check['Editor'],
    "class"     => "text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$source = array(
    "name"      => "source",
    "value"     => $news_check['Source'],
    "class"     => "text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$tags = array(
    "name"      => "tags",
    "value"     => $news_check['Tags'],
    "class"     => "text width-400 height-32 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$mtit = array(
    "name"      => "mtit",
    "value"     => $news_check['MTit'],
    "class"     => "text width-400 height-32 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$mkey = array(
    "name"      => "mkey",
    "value"     => $news_check['MKey'],
    "class"     => "text width-400 height-32 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$mdes = array(
    "name"      => "mdes",
    "value"     => $news_check['MDes'],
    "class"     => "text width-400 height-32 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$submit = array(
    'name'      => 'bntOk',
...
<div class="content content-news padding-10 margin-10 background-color-f4f4f4 border-1 border-radius-8 border-color-ccc border-style-solid">
    ...
    <div class="section-left float-left">
        ...
        <?php 
            ...
            echo "</div>";
            //echo form_open("",$form);
            echo "<div class=\"item item-text\">".form_label(lang('backend.menu')." <span class=\"color-red\">*</span>")."<select name = 'menu'>".$news_menu."</select>"."<div class=\"clear-both\"></div></div>";
            ...
            if($news_check['Img']) {echo "<div class=\"item item-text\">".form_label("&nbsp;")."<img id=\"IMAGES_VALUE\" src=\"{$news_check['Img']}\" height=\"90\"/><div class=\"clear-both\"></div></div>";}
    ...
    <div class="section-right float-right">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="table-list-item" style="margin-top: 20px;">
            <tr class="head">
            ...
            <tr class="row">
                ...
                <td class="row-3"><a href="<?php echo base_url()."admin/site_news/edit/".$row['ID'];?>" title="<?php echo lang('backend.edit');?>" class="color-blue hover-underline"><?php echo $row['Name'];?></a><br /></td>
                <td class="row-4"><a href="<?php echo base_url()."admin/site_news/menu/".$row['Menu'];?>" title="Lọc theo danh mục <?php echo $row['MName'];?>" class="color-blue hover-underline"><?php echo $row['MName'];?></a></td>
