...
$landarea = array(
    "name"      => "landarea",
    "value"     => set_value("landarea"),
    "class"     => "text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$usablearea = array(
    "name"      => "usablearea",
    "value"     => set_value("usablearea"),
    "class"     => "text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$sittingroom = array(
    "name"      => "sittingroom",
    "value"     => set_value("sittingroom"),
    "class"     => "text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$bedroom = array(
    "name"      => "bedroom",
    "value"     => set_value("bedroom"),
    "class"     => "text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$toilet = array(
    "name"      => "toilet",
    "value"     => set_value("toilet"),
    "class"     => "text width-400 margin-0 padding-2 border-1 border-color-ccc border-style-solid",
);
$garage = array(
    "name"      => "garage",
...
<?php echo form_open_multipart("",$form);?>
    <div class="section-left float-left">
        ...
        <?php 
            ...
            echo "<div class=\"item item-text\">".form_label(lang('backend.type')).form_dropdown('type',$arrType)."<div class=\"clear-both\"></div></div>";
            ...
            echo "<div class=\"item item-text\">".form_label(lang('backend.province')).form_dropdown("province",array('8'=>'Bình Dương'),8,$province_attr)."<div class=\"clear-both\"></div></div>";
            echo "<div class=\"item item-text\">".form_label(lang('backend.district')).form_dropdown("district",$district_list,set_value("district"),$district_attr)."<div class=\"clear-both\"></div></div>";
            ...
            echo "<div class=\"item item-text\">".form_label(lang('backend.direction')).form_dropdown("direction",$direction_list,set_value("direction"))."<div class=\"clear-both\"></div></div>";//.form_input($direction)."<div class=\"clear-both\"></div></div>";
            echo "<div class=\"item item-text\">".form_label(lang('backend.cost')).form_input($cost)."<div class=\"clear-both\"></div></div>";
            echo "<div class=\"item item-text\">".form_label(lang('backend.unit')).form_dropdown("unit",$unit_list,set_value("unit"))."<div class=\"clear-both\"></div></div>";
            ...
            echo "<div class=\"item item-text\">".form_label("Tình trạng").form_dropdown("state",$state_list,set_value("unit"))."<div class=\"clear-both\"></div></div>";
            echo "<div class=\"item item-text\">".form_label(lang('backend.status')).form_dropdown('status',$arrStatus)."<div class=\"clear-both\"></div></div>";
